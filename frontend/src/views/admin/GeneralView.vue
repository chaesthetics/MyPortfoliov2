...
<div class="flex flex-col space-y-6">
    ...
    <div class="main py-6 px-8  items-center flex justify-around space-x-20 w-2/3">
        ...
        <div class="space-y-4">
            <div class="flex space-x-3 items-center">
                <button class="py-2 px-6 bg-neutral-800 text-white rounded-md hover:bg-neutral-900 shadow">Edit profile</button>
                <button class="py-2 px-6 bg-neutral-800 text-white rounded-md hover:bg-neutral-900 shadow">View Site</button>
    ...
    <div class="main  px-8  items-center flex space-x-3 w-2/3">
