...
import { ref } from "vue"; 
const { getProject, project, updateProject } = useAccount();
...
const submitHandler = async() => {
    try{
        await updateProject(route.params.id, projectIMG);
            ...
            <form action=""  @submit.prevent="submitHandler()" method="post">
                <div class="md:flex items-center mt-6 items-center justify-center">
                    <div class="flex relative justify-center items-center mt-6 group">
                        <img class="w-[400px] h-[200px] border border-gray-500 group-hover:opacity-20" :src="project.img" id="displayIMG">
                        <input @change="handleFileUpload" type="file" name="projectIMG" class="absolute top-1/2 w-[160px] opacity-0 z-50">
                ...
                <div class="md:flex items-center mt-6">
                    <div class="w-full md:w-1/2 flex flex-col">
                        ...
                        <input v-model="project.title" type="text" class="leading-none text-neutral-50 p-3 focus:outline-none focus:border-green-700 mt-4 border-0 bg-neutral-800 rounded" />
                    </div>
                    <div class="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                        <label class="font-semibold leading-none text-neutral-300">Git Repo</label>
                        <input v-model="project.link" type="text" class="leading-none text-neutral-50 p-3 focus:outline-none focus:border-green-700 mt-4 border-0 bg-neutral-800 rounded"/>
                    </div>
                </div>
                <div class="md:flex items-center mt-6">
                    <div class="w-full md:w-1/2 flex flex-col">
                        <label class="font-semibold leading-none text-neutral-300">Language Used</label>
                        <input v-model="project.language" type="text" class="leading-none text-neutral-50 p-3 focus:outline-none focus:border-green-700 mt-4 border-0 bg-neutral-800 rounded" />
                    </div>
                    <div class="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                        <label class="font-semibold leading-none text-neutral-300">Role</label>
                        <select  placeholder="Select Role" v-model="project.role" class="leading-none text-neutral-50 p-3 focus:outline-none focus:border-green-700 mt-4 border-0 bg-neutral-800 rounded">
                ...
                <div>
                    <div class="w-full flex flex-col mt-8">
                        ...
                        <textarea v-model="project.description" type="text" class="h-20 text-base leading-none text-neutral-50 p-3 focus:outline-none focus:border-green-700 mt-4 bg-neutral-800 border-0 rounded"></textarea>
                    </div>
                </div>
