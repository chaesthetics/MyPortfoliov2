  ...
  <div class="w-auto h-auto mt-[20%] md:mt-[10%] flex justify-around shrink mr-auto ml-auto pb-20x">
    <div class="card items-center md:grid md:grid-cols-2">
      ...
      <div class="flex space-x-3 justify-center mt-10 ml-1">
          ...
          <a href="https://facebook.com/aurieljames11" class="border border-yellow-300 text-white font-semibold pl-4 pr-4 pt-1 pb-1 flex items-center space-x-2 hover:border-yellow-300 animation duration-300 hover:shadow hover:shadow-yellow-500/50 hover:shadow-lg">
