  ...
  <div class="w-auto h-auto mt-[20%] md:mt-[10%] flex justify-around shrink mr-auto ml-auto pb-20x">
    <div class="card items-center md:grid md:grid-cols-2">
      <div class="w-100 space-y-1 md:space-y-4 mb-10 text-center md:text-left">
        ...
        <div>
          <p class="text-white leading-10 text-[50px] font-semibold">{{ profile.firstname }}</p>
          <p class="text-white leading-10 text-[50px] font-semibold">{{ profile.lastname }}</p>
        </div>
        ...
        <p class="text-zinc-300 font-semibold text-md">{{ profile.description }}</p>
      </div>
      ...
      <div class="flex space-x-3 justify-center mt-10 ml-1">
          <a v-bind:href="profile.githublink" class="border border-yellow-300 text-white font-semibold pl-4 pr-4 pt-1 pb-1 flex items-center space-x-2 hover:border-yellow-300 animation duration-300 hover:shadow hover:shadow-yellow-500/50 hover:shadow-lg">
          ...
          <a v-bind:href="profile.contactlink" class="border border-yellow-300 text-white font-semibold pl-4 pr-4 pt-1 pb-1 flex items-center space-x-2 hover:border-yellow-300 animation duration-300 hover:shadow hover:shadow-yellow-500/50 hover:shadow-lg">
